...
DROP TABLE IF EXISTS faccar.tab_pmtros_facturacion;                                         --p
DROP TABLE IF EXISTS faccar.tab_presupuesto;                                                --p
DROP TABLE IF EXISTS faccar.tab_aplicacion_nota;                                            --p
DROP TABLE IF EXISTS faccar.tab_nota;                                                       --p
DROP TABLE IF EXISTS faccar.tab_motivo_nota;                                                --p
DROP TABLE IF EXISTS faccar.tab_tipo_nota;                                                  --p
DROP TABLE IF EXISTS faccar.tab_pagos;                                                      --s
DROP TABLE IF EXISTS faccar.tab_segui_carteras;                                             --s    
DROP TABLE IF EXISTS faccar.tab_carteras;                                                   --s
DROP TABLE IF EXISTS faccar.tab_cond_pagos;                                                 --s
DROP TABLE IF EXISTS faccar.tab_fac_electronicas;                                           --p
DROP TABLE IF EXISTS faccar.tab_det_facturas;                                               --p
DROP TABLE IF EXISTS faccar.tab_enc_facturas;                                               --p
DROP TABLE IF EXISTS faccar.tab_det_cotizaciones;                                           --s
DROP TABLE IF EXISTS faccar.tab_enc_cotizaciones;                                           --s 
DROP TABLE IF EXISTS faccar.tab_vendedores;                                                 --s
DROP TABLE IF EXISTS faccar.tab_productos;                                                  
DROP TABLE IF EXISTS faccar.tab_clientes;                                                   --s
DROP TABLE IF EXISTS faccar.tab_forma_pagos;                                                --s
